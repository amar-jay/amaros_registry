    ...
    >
      <div className="flex size-full max-w-3xl items-center justify-between gap-6">
        ...
        <div className="flex flex-col items-center gap-1.5">
          <div
            ref={orgAMasterRef}
            className="z-10 flex size-16 items-center justify-center rounded-full border-2 border-indigo-500 bg-background p-2.5 shadow-md"
          >
            <IconBuildingSkyscraper className="size-7 text-indigo-500" />
          </div>
          <span className="text-xs font-semibold text-indigo-500">Org A</span>
        </div>
